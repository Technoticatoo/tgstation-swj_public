...
/datum/map_template/ruin/space/derelict6
	...
	name = "Derelict 6"
	description = "The hush-hush of the Empire when it comes to stations seemingly vanishing off the radar is an interesting topic, theories of nuclear destruction float about while Imperial \
