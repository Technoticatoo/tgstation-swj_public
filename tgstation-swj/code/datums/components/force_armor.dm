/datum/component/force_armor
	var/amount = 0
	var/maxamount = 3
	var/upgrade_item = /obj/item/stack/sheet/animalhide/force_armor
	var/datum/armor/added_armor = list("melee" = 10)
	var/upgrade_name

/datum/component/force_armor/Initialize(_maxamount,obj/item/_upgrade_item,datum/armor/_added_armor)
	if(!isobj(parent))
...
/datum/component/force_armor/proc/examine(datum/source, mob/user)
...
/datum/component/force_armor/proc/applyplate(datum/source, obj/item/I, mob/user, params)
...
/datum/component/force_armor/proc/dropplates(datum/source, force)
