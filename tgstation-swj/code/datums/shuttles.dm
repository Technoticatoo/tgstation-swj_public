...
/datum/map_template/shuttle/emergency/asteroid
	...
	description = "A respectable mid-sized shuttle that first saw service shuttling Imperial crew to and from their asteroid belt embedded facilities."
	credit_cost = 3000
...
/datum/map_template/shuttle/emergency/discoinferno
	suffix = "discoinferno"
	name = "Disco Inferno"
	description = "The glorious results of centuries of plasma research done by Imperial employees. This is the reason why you are here. Get on and dance like you're on fire, burn baby burn!"
...
/datum/map_template/shuttle/emergency/goon
	suffix = "goon"
	name = "NES Port"
	description = "The Imperial Emergency Shuttle Port(NES Port for short) is a shuttle used at other less known Imperial facilities and has a more open inside for larger crowds, but fewer onboard shuttle facilities."
	credit_cost = 500
