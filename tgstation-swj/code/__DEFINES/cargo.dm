...
#define POD_STYLES list(\
    list("supplypod", "supply pod", "A Imperial supply drop pod."),\
    list("bluespacepod", "bluespace supply pod" , "A Imperial Bluespace supply pod. Teleports back to CentCom after delivery."),\
    list("centcompod", "\improper Centcom supply pod", "A Imperial supply pod, this one has been marked with Central Command's designations. Teleports back to Centcom after delivery."),\
    list("syndiepod", "blood-red supply pod", "A dark, intimidating supply pod, covered in the blood-red markings of the Rebel. It's probably best to stand back from this."),\
    list("squadpod", "\improper MK. II supply pod", "A Imperial supply pod. This one has been marked the markings of some sort of elite strike team."),\
    list("cultpod", "bloody supply pod", "A Imperial supply pod covered in scratch-marks, blood, and strange runes."),\
    ...
    list("smissilepod", "\improper Rebel cruise missile", "A big ass, blood-red missile that didn't seem to fully detonate. It was likely launched from some deep space Rebel missile silo. There appears to be an auxillery payload hatch on the side, though manually opening it is likely impossible."),\
