...
/datum/reagent/consumable/ethanol/cuba_libre
	...
	glass_desc = "A classic mix of rum, cola, and lime. A favorite of rebels everywhere!"

/datum/reagent/consumable/ethanol/cuba_libre/on_mob_life(mob/living/carbon/M)
	if(M.mind && M.mind.has_antag_datum(/datum/antagonist/rev)) //Cuba Libre, the traditional drink of rebellions! Heals rebels.
...
/datum/reagent/consumable/ethanol/screwdrivercocktail/on_mob_life(mob/living/carbon/M)
	if(M.mind && M.mind.assigned_role in list("Engineer Corporal", "Engineer Private", "Engineer Sergeant")) //Engineers lose radiation poisoning at a massive rate.
...
/datum/reagent/consumable/ethanol/manhattan
	name = "Manhattan"
	id = "manhattan"
	description = "The Interrogator's undercover drink of choice. He never could stomach gin..."
	color = "#664300" // rgb: 102, 67, 0
	boozepwr = 30
	quality = DRINK_NICE
	...
	glass_desc = "The Interrogator's undercover drink of choice. He never could stomach gin..."
...
/datum/reagent/consumable/ethanol/grog
	name = "Grog"
	id = "grog"
	description = "Watered down rum, Imperial approves!"
	color = "#664300" // rgb: 102, 67, 0
...
/datum/reagent/consumable/ethanol/acid_spit
	...
	glass_desc = "A drink from Imperial. Made from live aliens."

/datum/reagent/consumable/ethanol/amasec
	name = "Amasec"
	id = "amasec"
	description = "Official drink of the Imperial Gun-Club!"
	color = "#664300" // rgb: 102, 67, 0
	boozepwr = 35
	quality = DRINK_GOOD
...
/datum/reagent/consumable/ethanol/atomicbomb
	...
	glass_desc = "Imperial cannot take legal responsibility for your actions after imbibing."
...
/datum/reagent/consumable/ethanol/between_the_sheets
	...
	glass_desc = "The only drink that comes with a label reminding you of Imperial's zero-tolerance promiscuity policy."
