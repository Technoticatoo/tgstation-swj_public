...
/datum/round_event/shuttle_loan/announce(fake)
	...
	switch(dispatch_type)
		...
		if(MY_GOD_JC)
			priority_announce("Cargo: We have discovered an active Rebel bomb near our VIP shuttle's fuel lines. If you feel up to the task, we will pay you for defusing it.", "CentCom Security Division")
...
/datum/round_event/shuttle_loan/proc/loan_shuttle()
	...
	switch(dispatch_type)
		if(HIJACK_SYNDIE)
			SSshuttle.centcom_message += "Rebel hijack team incoming."
		if(RUSKY_PARTY)
