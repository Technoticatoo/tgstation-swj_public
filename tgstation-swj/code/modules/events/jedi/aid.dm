//in this file: Various events that directly aid the jedi. This is the "lets entice the jedi to use summon events!" file.

/datum/round_event_control/jedi/robelesscasting //EI NUDTH!
	name = "Robeless Casting"
	weight = 2
	typepath = /datum/round_event/jedi/robelesscasting
	max_occurrences = 1
	earliest_start = 0 MINUTES

/datum/round_event/jedi/robelesscasting/start()
...
/datum/round_event_control/jedi/improvedcasting //blink x5 disintergrate x5 here I come!
	name = "Improved Casting"
	weight = 3
	typepath = /datum/round_event/jedi/improvedcasting
	max_occurrences = 4 //because that'd be max level spells
	earliest_start = 0 MINUTES

/datum/round_event/jedi/improvedcasting/start()
