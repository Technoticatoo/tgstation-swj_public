/datum/round_event_control/jedi/deprevolt //stationwide!
	...
	typepath = /datum/round_event/jedi/deprevolt
	max_occurrences = 1
	earliest_start = 0 MINUTES

/datum/round_event/jedi/deprevolt/start()
	...
	switch(tidecolor)
		...
		if("yellow")
			jobs_to_revolt = list("Engineer Sergeant", "Engineer Corporal", "Engineer Private")
			nation_name = pick("Atomo", "Engino", "Power", "Teleco")
		if("purple")
			jobs_to_revolt = list("Science Director","Scientist", "Roboticist")
