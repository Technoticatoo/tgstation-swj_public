/datum/round_event_control/jedi/magicarp //these fish is loaded
	name = "Magicarp"
	weight = 1
	typepath = /datum/round_event/jedi/magicarp
	max_occurrences = 1
	earliest_start = 0 MINUTES

/datum/round_event/jedi/magicarp
	announceWhen	= 3
	startWhen = 50

/datum/round_event/jedi/magicarp/setup()
	startWhen = rand(40, 60)

/datum/round_event/jedi/magicarp/announce(fake)
	priority_announce("Unknown magical entities have been detected near [station_name()], please stand-by.", "Lifesign Alert")

/datum/round_event/jedi/magicarp/start()
