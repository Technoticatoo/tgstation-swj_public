/datum/round_event_control/jedi/rpgloot //its time to minmax your shit
	name = "RPG Loot"
	weight = 3
	typepath = /datum/round_event/jedi/rpgloot
	max_occurrences = 1
	earliest_start = 0 MINUTES

/datum/round_event/jedi/rpgloot/start()
...
/obj/item/upgradescroll/unlimited
	...
	desc = "Somehow, this piece of paper can be applied to items to make them \"better\". This scroll is made from the tongues of dead paper jedis, and can be used an unlimited number of times, with no drawbacks."
	one_use = FALSE
	can_backfire = FALSE
