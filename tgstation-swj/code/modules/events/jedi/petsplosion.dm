/datum/round_event_control/jedi/petsplosion //the horror
	name = "Petsplosion"
	weight = 2
	typepath = /datum/round_event/jedi/petsplosion
	max_occurrences = 1 //Exponential growth is nothing to sneeze at!
	earliest_start = 0 MINUTES
	var/mobs_to_dupe = 0

/datum/round_event_control/jedi/petsplosion/preRunEvent()
...
/datum/round_event/jedi/petsplosion
	endWhen = 61 //1 minute (+1 tick for endWhen not to interfere with tick)
	var/countdown = 0
	var/mobs_duped = 0

/datum/round_event/jedi/petsplosion/tick()
