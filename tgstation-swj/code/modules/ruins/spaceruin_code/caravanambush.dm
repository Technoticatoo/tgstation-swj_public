...
/obj/machinery/computer/shuttle/caravan/syndicate1
	name = "Rebel Fighter Shuttle Console"
	desc = "Used to control the Rebel Fighter."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	light_color = LIGHT_COLOR_RED
...
/obj/machinery/computer/camera_advanced/shuttle_docker/caravan/syndicate1
	name = "Rebel Fighter Navigation Computer"
	desc = "Used to designate a precise transit location for the Rebel Fighter."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	shuttleId = "caravansyndicate1"
	lock_override = NONE
...
/obj/machinery/computer/shuttle/caravan/syndicate3
	name = "Rebel Drop Ship Console"
	desc = "Used to control the Rebel Drop Ship."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	req_access = list(ACCESS_SYNDICATE)
	light_color = LIGHT_COLOR_RED
...
/obj/machinery/computer/camera_advanced/shuttle_docker/caravan/syndicate3
	name = "Rebel Drop Ship Navigation Computer"
	desc = "Used to designate a precise transit location for the Rebel Drop Ship."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	shuttleId = "caravansyndicate3"
	lock_override = NONE
