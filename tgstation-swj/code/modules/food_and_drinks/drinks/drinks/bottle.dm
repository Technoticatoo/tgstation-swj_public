...
/obj/item/reagent_containers/food/drinks/bottle/absinthe/proc/redact()
	...
	switch(shortname)
		...
		if("Generic")
			fullname = "Kuat Cheap Imitations"
...
/obj/item/reagent_containers/food/drinks/bottle/molotov
	...
	desc = "A throwing weapon used to ignite things, typically filled with an accelerant. Recommended highly by rioters and rebels. Light and toss."
	icon_state = "vodkabottle"
	list_reagents = list()
