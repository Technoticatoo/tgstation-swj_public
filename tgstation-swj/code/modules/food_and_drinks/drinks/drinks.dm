...
/obj/item/reagent_containers/food/drinks/ice/prison
	name = "dirty ice cup"
	desc = "Either the Empire's water supply is contaminated, or this machine actually vends lemon, chocolate, and cherry snow cones."
...
/obj/item/reagent_containers/food/drinks/flask/det
	name = "Interrogator's flask"
	desc = "The Interrogator's only true friend."
	icon_state = "detflask"
