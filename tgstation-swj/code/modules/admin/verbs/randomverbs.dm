...
/client/proc/admin_headset_message(mob/M in GLOB.mob_list, sender = null)
	...
	if (!sender)
		sender = input("Who is the message from?", "Sender") as null|anything in list("CentCom","Rebel")
		if(!sender)
			return
	...
	to_chat(H, "You hear something crackle in your ears for a moment before a voice speaks.  \"Please stand by for a message from [sender == "Rebel" ? "your benefactor" : "Central Command"].  Message as follows[sender == "Rebel" ? ", agent." : ":"] <span class='bold'>[input].</span> Message ends.\"")
