...
/datum/admins/proc/one_click_antag()
	...
	var/dat = {"
		...
		<a href='?src=[REF(src)];[HrefToken()];makeAntag=jedi'>Make Jedi (Requires Ghosts)</a><br>
...
/datum/admins/proc/makeRevs()
	...
	var/datum/game_mode/rebellion/temp = new
	if(CONFIG_GET(flag/protect_roles_from_antagonist))
		temp.restricted_jobs += temp.protected_jobs
...
/datum/admins/proc/makeJedi()
	...
	var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you wish to be considered for the position of a Jedi Foundation 'diplomat'?", ROLE_WIZARD, null)
