/datum/bounty/item/assistant/strange_object
	name = "Strange Object"
	description = "the Empire has taken an interest in strange objects. Find one in maint, and ship it off to CentCom right away."
	reward = 1200
	wanted_types = list(/obj/item/relic)

/datum/bounty/item/assistant/scooter
	name = "Scooter"
	description = "The Empire has determined walking to be wasteful. Ship a scooter to CentCom to speed operations up."
...
/datum/bounty/item/assistant/skateboard
	name = "Skateboard"
	description = "The Empire has determined walking to be wasteful. Ship a skateboard to CentCom to speed operations up."
...
/datum/bounty/item/assistant/donut
	name = "Donuts"
	description = "CentCom's security forces are facing heavy losses against the Rebel. Ship donuts to raise morale."
	reward = 3000
	required_count = 10
...
/datum/bounty/item/assistant/poppy
	name = "Poppies"
	description = "Commander Zot really wants to sweep Stormtrooper Olivia off her feet. Send a shipment of Poppies - her favorite flower - and he'll happily reward you."
	reward = 1000
	required_count = 3
...
/datum/bounty/item/assistant/ied
	name = "IED"
	description = "The Empire's maximum security prison at CentCom is undergoing personnel training. Ship a handful of IEDs to serve as a training tools."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/corgimeat
	name = "Raw Corgi Meat"
	description = "The Rebel recently stole all of CentCom's corgi meat. Ship out a replacement immediately."
	reward = 3000
