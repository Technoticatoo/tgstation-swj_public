...
/datum/bounty/item/medical/eye
	name = "Organic Eyes"
	description = "Station 5's Science Director Willem is requesting a few pairs of non-robotic eyes. Don't ask questions, just ship them."
	reward = 10000
	required_count = 3
...
/datum/bounty/item/medical/lizard_tail
	name = "Lizard Tail"
	description = "The Rebellion has made off with Imperial's supply of lizard tails. While CentCom is dealing with the jedis, can the station spare a tail of their own?"
	reward = 3000
