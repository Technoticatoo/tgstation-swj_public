...
/obj/machinery/computer/bounty
	name = "Imperial bounty console"
	desc = "Used to check and claim bounties offered by Imperial"
	icon_screen = "bounty"
...
/obj/item/paper/bounty_printout/Initialize()
	. = ..()
	info = "<h2>Imperial Cargo Bounties</h2></br>"
...
/obj/machinery/computer/bounty/ui_interact(mob/user)
	...
	var/datum/browser/popup = new(user, "bounties", "Imperial Bounties", 700, 600)
