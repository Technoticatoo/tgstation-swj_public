...
/obj/machinery/nuclearbomb/ui_data(mob/user)
	...
	var/second_status = exploded ? "Warhead triggered, thanks for flying Imperial" : (safety ? "Safe" : "Engaged")
...
/obj/machinery/nuclearbomb/beer
	name = "Imperial-brand nuclear fission explosive"
	desc = "One of the more successful achievements of the Imperial Corporate Warfare Division, their nuclear fission explosives are renowned for being cheap to produce and devastatingly effective. Signs explain that though this particular device has been decommissioned, every Imperial station is equipped with an equivalent one, just in case. All Captains carefully guard the disk needed to detonate them - at least, the sign says they do. There seems to be a tap on the back."
	proper_bomb = FALSE
