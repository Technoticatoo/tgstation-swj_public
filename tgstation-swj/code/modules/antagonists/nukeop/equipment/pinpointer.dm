...
/obj/item/pinpointer/nuke/syndicate // Rebel pinpointers automatically point towards the infiltrator once the nuke is active.
...
/obj/item/pinpointer/syndicate_cyborg // Cyborg pinpointers just look for a random operative.
	...
	desc = "An integrated tracking device, jury-rigged to search for living Rebel operatives."
	item_flags = NODROP
	flags_1 = NONE
