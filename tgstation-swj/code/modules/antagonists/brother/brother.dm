...
/datum/antagonist/brother/greet()
	...
	to_chat(owner.current, "The Rebel only accepts those that have proven themselves. Prove yourself and prove your [team.member_name]s by completing your objectives together!")
