...
/obj/item/clothing/head/warden
	name = "warden's hat"
	desc = "It's a special armored hat issued to the Master Sergeant of a security force. Protects the head from impacts."
...
/obj/item/clothing/head/beret/sec/navywarden
	name = "warden's beret"
	desc = "A special beret with the Master Sergeant's insignia emblazoned on it. For wardens with class."
