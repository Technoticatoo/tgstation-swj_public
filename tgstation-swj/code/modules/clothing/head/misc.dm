...
/obj/item/clothing/head/syndicatefake
	...
	desc = "A plastic replica of a Rebel agent's space helmet. You'll look just like a real murderous Rebel agent in this! This is a toy, it is not made for use in space!"
