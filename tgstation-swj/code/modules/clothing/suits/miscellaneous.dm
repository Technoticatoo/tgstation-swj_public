...
/obj/item/clothing/suit/syndicatefake
	...
	desc = "A plastic replica of the Rebel space suit. You'll look just like a real murderous Rebel agent in this! This is a toy, it is not made for use in space!"
...
/obj/item/clothing/suit/jacket/letterman_nanotrasen
	...
	desc = "A blue letterman jacket with a proud Imperial Logo on the back. The tag says that it was made in Space China."
