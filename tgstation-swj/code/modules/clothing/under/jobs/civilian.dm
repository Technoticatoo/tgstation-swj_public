...
/obj/item/clothing/under/rank/sith
	desc = "It's a sith standard clothing, very ominous."
	name = "sith's robe"
	icon_state = "sith_robe"
	item_state = "sith_robe"
	item_color = "sith_robe"
	sensor_mode = SENSOR_COORDS
	random_sensor = FALSE
...
/obj/item/clothing/under/lawyer/blacksuit
	name = "black suit"
	desc = "A professional black suit. The Imperial Investigation Bureau approved!"
