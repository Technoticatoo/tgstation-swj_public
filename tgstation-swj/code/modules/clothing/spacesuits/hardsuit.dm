...
/obj/item/clothing/suit/space/hardsuit/captain
	...
	desc = "A MK.II SWAT suit with streamlined joints and armor made out of superior materials, insulated against intense heat. The most advanced tactical armor available Usually reserved for heavy hitter corporate security, this one has a regal finish in imperial colors. Better not let the assistants get a hold of it."
	icon_state = "caparmor"
...
/obj/item/clothing/head/helmet/space/hardsuit/sith/attack_self()
	return //Sprites required for flashlight
...
/obj/item/clothing/suit/space/hardsuit/sith/Initialize()
	. = ..()
	allowed = GLOB.security_hardsuit_allowed
