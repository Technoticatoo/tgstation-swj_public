...
/obj/effect/proc_holder/spell/targeted/lichdom/cast(list/targets,mob/user = usr)
	for(var/mob/M in targets)
		...
		if(ishuman(M))
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/head/jedi/black(H), SLOT_HEAD)
...
/obj/item/phylactery/proc/rise()
	...
	lich.equip_to_slot_or_del(new /obj/item/clothing/head/jedi/black(lich), SLOT_HEAD)
