/obj/effect/proc_holder/spell/aoe_turf/conjure
	...
	//should have format of list("emagged" = 1,"name" = "Jedi's Justicebot"), for example
...
/obj/effect/proc_holder/spell/aoe_turf/conjure/summonEdSwarm //test purposes - Also a lot of fun
	name = "Dispense Jedi Justice"
	desc = "This spell dispenses jedi justice."

	summon_type = list(/mob/living/simple_animal/bot/ed209)
	summon_amt = 10
	range = 3
	newVars = list("emagged" = 2, "remote_disabled" = 1,"shoot_sound" = 'sound/weapons/laser.ogg',"projectile" = /obj/item/projectile/beam/laser, "declare_arrests" = 0,"name" = "Jedi's Justicebot")
