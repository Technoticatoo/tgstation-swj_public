/mob/living/simple_animal/hostile/jedi
	name = "Jedi"
	desc = "EI NATH?"
	...
	minimum_distance = 3
	del_on_death = 1
	loot = list(/obj/effect/mob_spawn/human/corpse/jedi,
				/obj/item/staff)
...
/mob/living/simple_animal/hostile/jedi/Initialize()
	. = ..()
...
/mob/living/simple_animal/hostile/jedi/handle_automated_action()
	. = ..()
