/mob/living/simple_animal/hostile/stickman
	...
	var/datum/action/boss/jedi_summon_minions/changesummons = /datum/action/boss/jedi_summon_minions
	var/summoned_by_jedi = 0
...
/mob/living/simple_animal/hostile/stickman/Initialize(mapload, var/jedi_summoned)
	. = ..()
	new /obj/effect/temp_visual/paper_scatter(src)
	summoned_by_jedi = jedi_summoned

/mob/living/simple_animal/hostile/stickman/death()
	..()
	if(summoned_by_jedi == 1)
