/datum/species/mush //mush mush codecuck
	...
	blacklisted = TRUE //See comment below about locking it out of roundstart. The species is not intended to be available to players yet - and this means jedis, too.
