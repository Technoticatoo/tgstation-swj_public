...
/datum/uplink_item/dangerous/flamethrower
	name = "Flamethrower"
	desc = "A flamethrower, fueled by a portion of highly flammable biotoxins stolen previously from Imperial \
...
/datum/uplink_item/suits/hardsuit
	...
	desc = "The feared suit of a syndicate nuclear agent. Features slightly better armoring and a built in jetpack \
			...
			Imperial crew who spot these suits are known to panic."
...
/datum/uplink_item/device_tools/rad_laser
	...
	desc = "A radioactive microlaser disguised as a standard Imperial health analyzer. When used, it emits a \
...
/datum/uplink_item/role_restricted/blastcannon
	...
	restricted_roles = list("Science Director", "Scientist")
