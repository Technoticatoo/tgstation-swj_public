...
/obj/item/storage/bag/ore/holding //miners, your messiah has arrived
	...
	desc = "A rebellion in convenience, this satchel allows for huge amounts of ore storage. It's been outfitted with anti-malfunction safety measures."
...
/obj/item/storage/bag/sheetsnatcher
	name = "sheet snatcher"
	desc = "A patented Imperial storage system designed for any kind of mineral sheet."
	icon = 'icons/obj/mining.dmi'
