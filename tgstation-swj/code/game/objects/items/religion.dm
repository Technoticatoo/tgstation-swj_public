/obj/item/banner
	name = "banner"
	desc = "A banner with Imperial's logo on it."
...
/obj/item/banner/security
	...
	job_loyalties = list("Stormtrooper", "Master Sergeant", "Interrogator", "Stormtrooper Commander")
...
/obj/item/banner/science
	...
	job_loyalties = list("Scientist", "Roboticist", "Science Director")
...
/obj/item/banner/engineering
	...
	job_loyalties = list("Engineer Corporal", "Engineer Private", "Engineer Sergeant")
...
/obj/item/banner/command
	...
	job_loyalties = list("Captain", "Lieutenant", "Engineer Sergeant", "Stormtrooper Commander", "Science Director", "Chief Medical Officer")
	warcry = "Hail Imperial!"
...
/obj/item/storage/backpack/bannerpack
	...
	desc = "It's a backpack with lots of extra room.  A banner with Imperial's logo is attached, that can't be removed."
