/obj/item/implant/spell
	name = "spell implant"
	desc = "Allows you to cast a spell as if you were a jedi."
	activated = FALSE
...
/obj/item/implant/spell/get_data()
	var/dat = {"<b>Implant Specifications:</b><BR>
				...
				<b>Function:</b> [spell ? "Allows a non-jedi to cast [spell] as if they were a jedi." : "None"]"}
	return dat
...
/obj/item/implantcase/spell
	name = "implant case - 'Jediry'"
	desc = "A glass case containing an implant that can teach the user the arts of Jediry."
	imp_type = /obj/item/implant/spell
