...
/obj/item/cardboard_cutout/proc/change_appearance(obj/item/toy/crayon/crayon, mob/living/user)
	...
	switch(new_appearance)
		...
		if("Jedi")
			name = "[pick(GLOB.jedi_first)], [pick(GLOB.jedi_second)]"
			desc = "A cardboard cutout of a jedi."
			icon_state = "cutout_jedi"
		if("Shadowling")
			name = "Unknown"
		...
		if("Laughter Demon")
			...
			icon = 'icons/mob/mob.dmi'
			icon_state = "bowmon"
		if("Private Stormtrooper")
			name = "Private Stormtrooper"
			desc = "A cardboard cutout of a private Stormtrooper."
