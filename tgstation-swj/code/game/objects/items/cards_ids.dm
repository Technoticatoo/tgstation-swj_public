...
/obj/item/card/id/away/old/sec
	name = "Charlie Station Stormtrooper's ID card"
	desc = "A faded Charlie Station ID card. You can make out the rank \"Stormtrooper\"."
	assignment = "Charlie Station Stormtrooper"
