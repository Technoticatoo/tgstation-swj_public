...
/obj/item/book/manual/ripley_build_and_repair
	...
	dat = {"<html>
				...
				<li>Imperial is determined to the safety of its <s>investments</s> employees.</li>
				</ol>
				</body>
				</html>

				<h2>Operation</h2>
				Please consult the Imperial compendium "Robotics for Dummies".
			"}
...
/obj/item/book/manual/nuclear
	...
	dat = {"<html>
			...
			Intelligence Analysts believe that normal Imperial procedure is for the Captain to secure the nuclear authorisation disk.<br>
			Good luck!
			</html>"}
...
/obj/item/book/manual/wiki/security_space_law
	name = "Space Law"
	desc = "A set of Imperial guidelines for keeping law and order on their space stations."
...
/obj/item/book/manual/wiki/detective
	...
	icon_state ="bookInterrogator"
	author = "Imperial"
	title = "The Film Noir: Proper Procedures for Investigations"
	page_link = "Interrogator"
