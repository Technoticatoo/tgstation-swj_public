...
/obj/item/station_charter/flag/rename_station(designation, uname, ureal_name, ukey)
	...
	desc = "The banner bears the official coat of arms of the Empire, signifying that [station_name()] has been claimed by Captain [uname] in the name of the company."
	SSblackbox.record_feedback("text", "station_renames", 1, "[station_name()]")
	if(!unlimited_uses)
		used = TRUE
