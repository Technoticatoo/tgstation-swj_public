...
/obj/structure/noticeboard/hop
	name = "Lieutenant's Notice Board"
	desc = "Important notices from the Lieutenant."
	req_access = list(ACCESS_HOP)

/obj/structure/noticeboard/ce
	name = "Engineer Sergeant's Notice Board"
	desc = "Important notices from the Engineer Sergeant."
	req_access = list(ACCESS_CE)

/obj/structure/noticeboard/hos
	name = "Stormtrooper Commander's Notice Board"
	desc = "Important notices from the Stormtrooper Commander."
...
/obj/structure/noticeboard/rd
	name = "Science Director's Notice Board"
	desc = "Important notices from the Science Director."
