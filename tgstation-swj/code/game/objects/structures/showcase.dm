...
/obj/structure/showcase/mecha/marauder
	...
	desc = "A stand with an empty old Imperial Corporation combat mech bolted to it. It is described as the premier unit used to defend corporate interests and employees."
...
/obj/structure/showcase/machinery/implanter
	name = "Imperial automated mindshield implanter exhibit"
	desc = "A flimsy model of a standard Imperial automated mindshield implant machine. With secure positioning harnesses and a robotic surgical injector, brain damage and other serious medical anomalies are now up to 60% less likely!"
	icon = 'icons/obj/machines/implantchair.dmi'
	icon_state = "implantchair"

/obj/structure/showcase/machinery/microwave
	name = "Imperial-brand microwave"
	desc = "The famous Imperial-brand microwave, the multi-purpose cooking appliance every station needs! This one appears to be drawn onto a cardboard box."
	icon = 'icons/obj/kitchen.dmi'
	icon_state = "mw"

/obj/structure/showcase/machinery/cloning_pod
	name = "cloning pod exhibit"
	desc = "Signs describe how cloning pods like these ensure that every Imperial employee can carry out their contracts in full, even in the unlikely event of their catastrophic death. Hopefully they aren't all made of cardboard, like this one."
	icon = 'icons/obj/machines/cloning.dmi'
	icon_state = "pod_0"

/obj/structure/showcase/perfect_employee
	name = "'Perfect Man' employee exhibit"
	desc = "A stand with a model of the perfect Imperial Employee bolted to it. Signs indicate it is robustly genetically engineered, as well as being ruthlessly loyal."

/obj/structure/showcase/machinery/tv
	name = "Imperial corporate newsfeed"
	desc = "A slightly battered looking TV. Various Imperial infomercials play on a loop, accompanied by a jaunty tune."
	icon = 'icons/obj/computer.dmi'
