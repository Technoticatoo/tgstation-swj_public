...
/datum/objective/hijack
	name = "hijack"
	explanation_text = "Hijack the shuttle to ensure no loyalist Imperial crew escape alive and out of custody."
	team_explanation_text = "Hijack the shuttle to ensure no loyalist Imperial crew escape alive and out of custody. Leave no team member behind."
...
/datum/objective/steal/exchange/proc/set_faction(faction,otheragent)
	...
	explanation_text = "Acquire [targetinfo.name] held by [target.current.real_name], the [target.assigned_role] and rebel agent"
	steal_target = targetinfo.targetitem
...
/datum/objective/steal/exchange/update_explanation_text()
	..()
	if(target && target.current)
		explanation_text = "Acquire [targetinfo.name] held by [target.name], the [target.assigned_role] and rebel agent"
	else
		explanation_text = "Free Objective"
...
/datum/objective/steal_five_of_type/summon_magic
	...
	wanted_items = list(/obj/item/spellbook, /obj/item/gun/magic, /obj/item/clothing/suit/space/hardsuit/jedi, /obj/item/scrying, /obj/item/antag_spawner/contract, /obj/item/necromantic_stone)
...
/datum/objective/changeling_team_objective/impersonate_department/proc/get_department_staff()
	...
	var/list/departments = list("Stormtrooper Commander","Science Director","Chief Engineer","Chief Medical Officer")
