...
/datum/game_mode/traitor/changeling/generate_report()
	return "The Rebel has started some experimental research regarding humanoid shapeshifting.  There are rumors that this technology will be field tested on an Imperial station \
