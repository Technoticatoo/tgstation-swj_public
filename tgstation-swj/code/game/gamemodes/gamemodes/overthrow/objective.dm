...
// based on the role of the head (Captain, HoP/HoS, other heads, warden, Stormtroopers) and whether you converted them, exiled or just killed (applying a modifier of 1.5, 1 and 0.5 respectively)
