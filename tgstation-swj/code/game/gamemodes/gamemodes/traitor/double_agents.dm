...
/datum/game_mode/traitor/internal_affairs
	...
	announce_text = "There are Imperial Agents trying to kill each other!\n\
...
/datum/game_mode/traitor/internal_affairs/generate_report()
	return "The Empire denies any accusations of placing internal affairs agents onboard your station to eliminate inconvenient employees.  Any further accusations against CentCom for such \
