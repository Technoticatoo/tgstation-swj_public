/datum/game_mode/devil
	...
	protected_jobs = list("Lawyer", "Curator", "Chaplain", "Stormtrooper Commander", "Captain", "AI")
	required_players = 0
	required_enemies = 1
...
/datum/game_mode/devil/generate_report()
	return "Infernal creatures have been seen nearby offering great boons in exchange for souls.  This is considered theft against the Empire, as all employment contracts contain a lien on the \
