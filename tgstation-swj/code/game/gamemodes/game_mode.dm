 ...
 * You can have proper jedis/traitors/changelings/cultists during any mode.
...
/datum/game_mode/proc/send_intercept()
	...
	intercepttext += "<b>Central Command has intercepted and partially decoded a Rebel transmission with vital information regarding their movements. The following report outlines the most \
			...
			if(D.mind && D.mind.current == L)
				if(L.stat == DEAD)
					...
					if(D.can_reenter_corpse)
						continue //Adminghost, or cult/jedi ghost
					else
