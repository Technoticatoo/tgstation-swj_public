...
/area
	...
	var/has_gravity = 0
	var/noteleport = FALSE			//Are you forbidden from teleporting to the area? (centcom, mobs, jedi, hand teleporter)
...
/*Adding a jedi area teleport list because motherfucking lag -- Urist*/
