...
/proc/religion_name()
	...
	name += pick("bee", "science", "edu", "captain", "assistant", "monkey", "alien", "space", "unit", "sprocket", "gadget", "bomb", "rebellion", "beyond", "station", "goon", "robot", "ivor", "hobnob")
...
/proc/syndicate_name()
	...
	if (prob(80))
		...
		// Full
		if (prob(60))
			name += pick("Rebel", "Consortium", "Collective", "Corporation", "Group", "Holdings", "Biotech", "Industries", "Systems", "Products", "Chemicals", "Enterprises", "Family", "Creations", "International", "Intergalactic", "Interplanetary", "Foundation", "Positronics", "Hive")
		// Broken
		else
